...
function drawMultpleLines (data) {
    var canvas = document.getElementById('line-chart');
    ...
    function drawMarkers() {
        ...
        for (let item of data) {
            newArr = newArr.concat(item.sale);
        }
    ...
    //绘制折线
    var colorArr = ["#60acfc","#32d3eb","#5bc49f","#feb64d","#ff7c7c","#9287e7","#222222","#444444","#666666"];
    for (let i = 0; i < data.length; i++) {
        drawLines(data[i].sale,colorArr[i]);
        drawDots(data[i].sale,colorArr[i]);
    }
    function drawLines(sales, strokeColor) {
    ...
    function drawDots(sales,fillColor) {
